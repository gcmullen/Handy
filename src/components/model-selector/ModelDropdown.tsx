...
const ModelDropdown: React.FC<ModelDropdownProps> = ({
  ...
  return (
    <div className="absolute bottom-full start-0 mb-2 w-64 max-h-[36rem] overflow-y-auto bg-background border border-mid-gray/20 rounded-lg shadow-lg py-2 z-50">
      {/* First Run Welcome */}
      {isFirstRun && (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm">
                      {getTranslatedModelName(model, t)}
                      {model.id === "parakeet-v3-int8" && isFirstRun && (
